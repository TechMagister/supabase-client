...
public class DateTimeConverter : JsonConverter
{
        ...
        JsonSerializer serializer)
    {
        if (reader.Value != null)
        {
            ...
            if (infinity != null) return (DateTime)infinity;
        ...
        try
        {
            ...
            foreach (var item in jo.ToArray())
            {
                ...
                if (infinity != null) result.Add((DateTime)infinity);
    ...
    {
        if (input.Contains("infinity")) return input.Contains("-") ? DateTime.MinValue : DateTime.MaxValue;
