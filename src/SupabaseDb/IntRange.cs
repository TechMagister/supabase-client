...
public class IntRange : IEquatable<IntRange>
{
    ...
    public static IntRange All => new(Index.Start, Index.End);
    ...
    {
        return new IntRange(start, Index.End);
    }

    /// <summary>Create a Range object starting from first element in the collection to the end Index.</summary>
    public static IntRange EndAt(Index end)
    {
        return new IntRange(Index.Start, end);
    }
...
internal static class RuntimeHelpers
{
    ...
    /// </summary>
    public static T[] GetSubArray<T>(T[] array, IntRange range)
    {
