...
namespace Supabase
{
    ...
    {
        public static Gotrue.StatelessClient.StatelessClientOptions GetAuthOptions(string supabaseUrl,
            string supabaseKey = null, SupabaseOptions options = null)
        {
            if (options == null)
        ...
        public static StatelessClientOptions GetRestOptions(string supabaseUrl, string supabaseKey = null,
            SupabaseOptions options = null)
        {
            ...
            return new StatelessClientOptions(string.Format(options.RestUrlFormat, supabaseUrl))
            {
        ...
        /// <returns></returns>
        public static Storage.Client Storage(string supabaseUrl, string supabaseKey = null,
            SupabaseOptions options = null)
        {
            if (options == null)
                options = new SupabaseOptions();
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public static SupabaseFunctions Functions(string supabaseUrl, string supabaseKey,
            SupabaseOptions options = null)
        {
            if (options == null)
                options = new SupabaseOptions();
        ...
        /// <returns></returns>
        public static SupabaseTable<T> From<T>(string supabaseUrl, string supabaseKey, SupabaseOptions options = null)
            where T : BaseModel, new()
        {
            ...
            return new SupabaseTable<T>(string.Format(options.RestUrlFormat, supabaseUrl), new ClientOptions
            {
                Headers = headers,
                Schema = options.Schema
            });
        ...
        /// <returns></returns>
        public static Task<BaseResponse> Rpc(string supabaseUrl, string supabaseKey, string procedureName,
            Dictionary<string, object> parameters, SupabaseOptions options = null)
        {
            if (options == null)
                options = new SupabaseOptions();

            return Postgrest.StatelessClient.Rpc(procedureName, parameters,
                GetRestOptions(supabaseUrl, supabaseKey, options));
        }
